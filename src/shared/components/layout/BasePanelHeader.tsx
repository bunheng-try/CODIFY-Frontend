...
export const BasePanelHeader = ({ left, center, right }: BasePanelHeaderProps) => {
    return (
        <div className="sticky top-0 z-10 bg-[hsl(var(--background))] border-b border-[hsl(var(--border))] px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
